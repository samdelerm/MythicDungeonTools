...
local dungeonIndex = 260
MDT.dungeonList[dungeonIndex] = L["TheAzureVault"]
MDT.mapInfo[dungeonIndex] = {
  shortName = L["theazurevaultShortName"],
  englishName = "TheAzureVault",
...
MDT.dungeonMaps[dungeonIndex] = {
  [0] = "",
  [1] = { customTextures = 'Interface\\AddOns\'..addonName..'\\'..'dragonflight\\Textures\\TheAzureVault' }
}
