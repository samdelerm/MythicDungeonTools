...
local dungeonIndex = 261
MDT.dungeonList[dungeonIndex] = L["TheNokhudOffensive"]
MDT.mapInfo[dungeonIndex] = {
  shortName = L["thenokhudoffensiveShortName"],
  englishName = "TheNokhudOffensive",
...
MDT.dungeonMaps[dungeonIndex] = {
  [0] = "",
  [1] = { customTextures = 'Interface\\AddOns\'..addonName..'\\'..'dragonflight\\Textures\\TheNokhudOffensive' }
}
