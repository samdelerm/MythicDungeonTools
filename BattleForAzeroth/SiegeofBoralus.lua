...
MDT.dungeonList[dungeonIndex] = L["SiegeofBoralus"]
MDT.mapInfo[dungeonIndex] = {
  shortName = L["siegeofboralusShortName"],
  englishName = "SiegeofBoralus",
...
MDT.dungeonMaps[dungeonIndex] = {
  [0] = "",
  [1] = { customTextures = 'Interface\\AddOns\'..addonName..'\\'..'battleforazeroth\\Textures\\SiegeofBoralus' }
}
